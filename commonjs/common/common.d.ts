...
export declare type Predicate<X> = (X: any) => boolean;
export declare type IInjectable = (Function | any[]);
export declare var abstractKey: string;
/**
 ...
 */
export declare function bindFunctions(from: any, to: any, bindTo: any, fnNames?: string[]): void;
/**
 * prototypal inheritance helper.
 * Creates a new object which has `parent` object as its prototype, and then copies the properties from `extra` onto it
 */
export declare const inherit: (parent: any, extra: any) => any;
 ...
 */
export declare function defaults(opts?: {}, ...defaultsList: any[]): any;
/**
 * Merges properties from the list of objects to the destination object.
 * If a property already exists in the destination object, then it is not overwritten.
 */
export declare function merge(dst: any, ...objs: Object[]): any;
/** Reduce function that merges each element of the list into a single object, using extend */
export declare const mergeR: (memo: any, item: any) => any;
/**
 ...
 */
export declare function ancestors(first: any, second: any): any[];
/**
 ...
 */
export declare function equalForKeys(a: any, b: any, keys?: string[]): boolean;
/**
 * @example
 * ```
 *
 ...
 */
export declare function pick(obj: any, propNames: string[]): Object;
/**
 * @example
 * ```
 *
 ...
 */
export declare function omit(obj: any, propNames: string[]): Object;
/**
 * @example
 * ```
 *
...
export declare function pluck(collection: any[], propName: string): any[];
...
export declare function filter<T>(collection: T[], callback: (T: any, key?: any) => boolean): T[];
/** Given an object, returns a new object with only those properties that passed the callback predicate */
export declare function filter<T>(collection: TypedMap<T>, callback: (T: any, key?: any) => boolean): TypedMap<T>;
 ...
 * ```
 */
export declare const pairs: (object: any) => any[][];
/**
