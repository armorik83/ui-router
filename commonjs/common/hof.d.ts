 ...
 */
export declare const not: (fn: any) => (...args: any[]) => boolean;
/**
 * Given two functions that return truthy or falsey values, returns a function that returns truthy
 * if both functions return truthy for the given arguments
 */
export declare function and(fn1: any, fn2: any): Function;
/**
 * Given two functions that return truthy or falsey values, returns a function that returns truthy
 * if at least one of the functions returns truthy for the given arguments
 */
export declare function or(fn1: any, fn2: any): Function;
/**
 ...
 */
export declare const all: (fn1: any) => (arr: any[]) => any;
export declare const any: (fn1: any) => (arr: any[]) => any;
export declare const none: Function;
/** Given a class, returns a Predicate function that returns true if the object is of that class */
export declare const is: (ctor: any) => (x: any) => boolean;
/** Given a value, returns a Predicate function that returns true if another value is === equal to the original value */
export declare const eq: (comp: any) => (x: any) => boolean;
